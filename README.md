...
Further details of how to build and modify ACCESS-OM3 are found on the ACCESS-om3 configuration documentation [here](https://access-om3-configs.access-hive.org.au/infrastructure/Building/).
